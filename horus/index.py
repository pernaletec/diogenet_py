...
from apps import local_network_graph, local_network_graph_centrality, communities_graph, communities_treemap
...
@app.callback(Output('confirm-warning-tie', 'displayed'),
              Input('graph_filter_global', 'value'))
def display_confirm_missin_tie_global_graph(graph_filter_global):
...
@app.callback(Output('confirm-warning-tie-centrality', 'displayed'),
              Input('graph_filter_global_centrality', 'value'))
def display_confirm_missin_tie_global_graph_centrality(graph_filter_global_centrality):
